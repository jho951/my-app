...
// sideBar 리스트
const SIDEBAR = [
  { id: 1, label: "비자 상담", href: "/side1", src: `${IMG_PATH}/sideBar/clinicalNotes.png` },
  { id: 2, label: "챗봇 상담", href: "/side2", src: `${IMG_PATH}/sideBar/forum.png` },
  { id: 3, label: "위챗 상담", href: "/side1", src: `${IMG_PATH}/sideBar/forum.png` },
  { id: 4, label: "왓츠앱 상담", href: "/side1", src: `${IMG_PATH}/sideBar/forum.png` },
  { id: 5, label: "1:1 상담 문의", href: "/side1", src: `${IMG_PATH}/sideBar/socialDistance.png` },
  { id: 6, label: "인스타그램", href: "/side1", src: `${IMG_PATH}/sideBar/Instagram.png` },
];
